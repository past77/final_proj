package ppolozhe.constants;

/**
 * Created by ppolozhe on 5/27/19.
 */
public class MassageForUsers {

        public String REGISTRATION = "registration";
        public String ERROR= "error";
        public String LOGIN = "login";
        public String MAIN = "mainPage";
        public String PROFILE = "profile";
        public String ADD_BOOKING = "addBooking";
        public String BOOKINGS_BY_USER = "bookingsByUser";
        public String ADD_APARTMENT = "addApartment";
        public String ALL_APARTMENTS = "allApartments";
        public String PROCESSED_BOOKINGS = "processedBookings";
        public String APARTMENTS = "freeNumbers";
        public String PASSWORD = "password";
        public String USER = "user";
        public String ERROR_LOGIN_PASS_MESSAGE = "errorLoginPassMessage";
        ...
        public String APARTMENTS_TYPE = "apartmentsType";
        ...
        public String FREE_NUMBERS = "freeNumbersForBooking";
        public String NUMBER_OF_PAGES = "noOfPages";
