...
public class JdbcBillDao implements BillDaoInterface {
    ...
    private static final String INSERT_BILL = "INSERT INTO `hotel`.`"+ TABLE_BILL +"` (`"+ PRICE +"`) VALUES (?);";
    private static final String UPDATE_BILL = "UPDATE `hotel`.`"+ TABLE_BILL + "` SET `"+ PRICE +"`=? WHERE `" + ID + "`=?;";
    private static final String DELETE_BILL= "DELETE FROM `hotel`.`"+ TABLE_BILL +"` WHERE `" + ID + "`=?;";


    private static final String FIND_ALL = "SELECT * FROM "+ TABLE_BILL +" ";
    private static final String FIND_BY_ID = FIND_ALL + " WHERE " + ID +" = ?";
    private static final String FIND_BY_BOOKING = FIND_ALL + " INNER JOIN booking ON "+ TABLE_BILL +"."+ ID +" = booking.idBill " +
    ...
    public Optional<Bill> findByBooking(Booking booking) throws Exception {
        ...
        try (JdbcConnection connection = connectionToDatabase.getConnection();
            ...
            LOGGER.info(JdbcBillDao.class.toString() + messageForLogger.FIND_BY_BOOKING + e.getMessage());
            throw new Exception();
        }
        return result;
    }
    ...
    public Optional<Bill> find(int id) throws Exception {
        ...
        try (JdbcConnection connection = connectionToDatabase.getConnection();
            ...
            LOGGER.info(JdbcBillDao.class.toString() + messageForLogger.FIND + e.getMessage());
            throw new Exception();
        }
        return result;
    }
    ...
    public List<Bill> findAll() throws Exception {
        ...
        try (JdbcConnection connection = connectionToDatabase.getConnection();
            ...
            LOGGER.info(JdbcBillDao.class.toString() + messageForLogger.FIND_ALL + e.getMessage());
            throw new Exception();
        }
        return result;
    }
    ...
    public boolean create(Bill bill) throws Exception {
        ...
        try (JdbcConnection connection = connectionToDatabase.getConnection();
            ...
            if (tableKeys.next())
                ...
                autoGeneratedID = result;
            }
            bill.setId(autoGeneratedID);
        } catch (SQLException e) {
            LOGGER.info(JdbcBillDao.class.toString() + messageForLogger.CREATE + e.getMessage());
            throw new Exception();
        }
    ...
    public boolean update(Bill bill) throws Exception {
        ...
        try (JdbcConnection connection = connectionToDatabase.getConnection();
            ...
            LOGGER.info(JdbcBillDao.class.toString() + messageForLogger.UPDATE + e.getMessage());
            throw new Exception();
        }
        return updatedRow > 0;
    }
    ...
    public boolean delete(int id) throws Exception {
        ...
        try (JdbcConnection connection = connectionToDatabase.getConnection();
            ...
            LOGGER.info(JdbcBillDao.class.toString() + messageForLogger.DELETE_BILL + e.getMessage());
            throw new Exception();
        }
        return deletedRow > 0;
    }
